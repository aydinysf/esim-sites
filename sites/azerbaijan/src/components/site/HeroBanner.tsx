    ...
    <>
      <div className="hero">
        <div>
          <div className="eyebrow">
            ...
            <span>CANLI · ƏHATƏ DAİRƏSİ AZƏRBAYCAN</span>
          </div>

          <h1>
            Qoşulun, <br />
            <span className="gradient-text">eniş etməzdən əvvəl.</span>
          </h1>

          <p className="lead">{subheadline || "Azərbaycan üçün müqaviləsiz və rouminq tələsiz prepaid eSIM. QR kod e-poçtla anında — baqajı götürməzdən əvvəl aktiv."}</p>

          <div className="check">
            <label htmlFor="dev">Telefonunuz eSIM dəstəkləyir?</label>
            <div className="row">
        ...
        <div className="phone-stage">
          ...
          <div className="screen">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-mono text-xs text-[var(--c5)]">● Bakıda aktivdir</span>
            </div>
      ...
      <div className="ticker-wrap">
        <div className="ticker-move">
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> BAKI ✦ GƏNCƏ ✦ SUMQAYIT ✦ ŞƏKİ ✦ LƏNKƏRAN ✦ QƏBƏLƏ ✦ NAXÇIVAN ✦ BAKI ✦ GƏNCƏ ✦ SUMQAYIT ✦ ŞƏKİ ✦ LƏNKƏRAN ✦ QƏBƏLƏ ✦ NAXÇIVAN</span>
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> BAKI ✦ GƏNCƏ ✦ SUMQAYIT ✦ ŞƏKİ ✦ LƏNKƏRAN ✦ QƏBƏLƏ ✦ NAXÇIVAN ✦ BAKI ✦ GƏNCƏ ✦ SUMQAYIT ✦ ŞƏKİ ✦ LƏNKƏRAN ✦ QƏBƏLƏ ✦ NAXÇIVAN</span>
        </div>
      </div>
    </>
