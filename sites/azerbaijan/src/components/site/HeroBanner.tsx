...
export default function HeroBanner() {
  ...
  return (
    <>
      <div className="hero">
        <div>
          <h1>Gəlin, skan edin və anında onlayn olun.</h1>
          <p className="lead">Azərbaycan üçün müqaviləsiz və rouminq ödənişsiz prepaid eSIM. QR kod e-poçtunuza anında göndərilir.</p>
          <div className="check">
      ...
      <svg className="ridge" viewBox="0 0 1080 200" role="img" aria-label="Panorama">
        ...
        <g>
          <text x="128" y="172">Bakı</text>
          <text x="398" y="164">Gəncə</text>
          <text x="694" y="172">Sumqayıt</text>
          <text x="940" y="186">Şəki</text>
        </g>
      </svg>
    </>
  );
