...
const navItems = [
  { href: "/admin", label: "İdarəetmə paneli", icon: "📊" },
  { label: "─ Məzmun", icon: "", href: "", divider: true },
  { href: "/admin/blog", label: "Blog", icon: "📝" },
  { href: "/admin/guides", label: "Bələdçilər", icon: "📚" },
  { href: "/admin/faq", label: "SSS", icon: "❓" },
  { href: "/admin/pages", label: "Səhifələr", icon: "📄" },
  { label: "─ Dizayn", icon: "", href: "", divider: true },
  { href: "/admin/banners", label: "Banner/Slayder", icon: "🖼️" },
  { href: "/admin/media", label: "Mediya Qalereyası", icon: "🎬" },
  { href: "/admin/menu", label: "Menyu", icon: "☰" },
  { href: "/admin/homepage", label: "Ana Səhifə", icon: "🏠" },
];
  ...
  return (
    <aside className="w-60 bg-gray-900 text-gray-300 flex flex-col min-h-screen flex-shrink-0">
      <div className="p-5 border-b border-gray-700">
        <div className="font-bold text-white text-sm">🇦🇿 eSIM Azərbaycan</div>
