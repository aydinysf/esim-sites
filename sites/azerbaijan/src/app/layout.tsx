...
export const metadata: Metadata = {
  ...
  description: "Azərbaycan üçün müqaviləsiz və rouminq tələsiz prepaid eSIM. QR kod e-poçtla anında — baqajı götürməzdən əvvəl aktiv.",
  robots: { index: true, follow: true },
};

export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="az" className={`${bricolage.variable} ${figtree.variable} ${jetbrains.variable}`}>
      <body>
