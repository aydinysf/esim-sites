...
export default async function HomePage() {
  ...
  const headline = homepage?.heroHeadline || "Qoşulun, eniş etməzdən əvvəl.";
  const subheadline = homepage?.heroSubheadline || "Azərbaycan üçün müqaviləsiz və rouminq tələsiz prepaid eSIM. QR kod e-poçtla anında — baqajı götürməzdən əvvəl aktiv.";
  const ctaText = homepage?.heroCtaText || "Tarifləri göstər";
  ...
  const stepsList = (Array.isArray(rawSteps) && rawSteps.length > 0) ? rawSteps : [
    { step: "01", title: "Tarif für Aserbaidschan wählen", description: "Wähle das passende Datenpaket für deine Reise. Der QR-Code wird sofort per E-Mail geliefert." },
    ...
    <>
      ...
      <section>
        <div className="cta-card">
          <h2 style={{ fontSize: "36px", marginBottom: "20px" }}>Nəyi gözləyirsiniz?</h2>
          <a className="btn-gradient" href="#tarife">İndi qoşulun</a>
        </div>
      </section>
