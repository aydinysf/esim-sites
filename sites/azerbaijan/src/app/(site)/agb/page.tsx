...
export const metadata: Metadata = {
  title: "Allgemeine Geschäftsbedingungen (AGB) | PoloSim Azərbaycan",
  description: "Allgemeine Geschäftsbedingungen für die Nutzung von PoloSim Azərbaycan eSIM Datendiensten.",
};
