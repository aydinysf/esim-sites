    ...
    <>
      <div className="hero">
        <div>
          ...
          <p className="lead">Prepaid-eSIM für Deutschland ohne Vertrag und ohne Roaming-Gebühren. Der QR-Code kommt sofort per E-Mail.</p>
          <div className="check">
      ...
      <svg className="ridge" viewBox="0 0 1080 200" role="img" aria-label="Panorama">
        ...
        <g>
          <text x="128" y="172">Berlin</text>
          <text x="398" y="164">München</text>
          <text x="694" y="172">Hamburg</text>
          <text x="940" y="186">Frankfurt</text>
        </g>
      </svg>
    </>
  );
