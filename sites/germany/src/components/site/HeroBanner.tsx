    ...
    <>
      <div className="hero">
        <div>
          <div className="eyebrow">
            ...
            <span>LIVE · NETZABDECKUNG DEUTSCHLAND</span>
          </div>
          ...
          <p className="lead">{subheadline || "Prepaid-eSIM für Deutschland ohne Vertrag und ohne Roaming-Falle. QR-Code direkt per E-Mail — aktiv, bevor das Gepäckband startet."}</p>
        ...
        <div className="phone-stage">
          ...
          <div className="screen">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-mono text-xs text-[var(--c5)]">● Aktiv in Berlin</span>
            </div>
      ...
      <div className="ticker-wrap">
        <div className="ticker-move">
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> BERLIN ✦ MÜNCHEN ✦ HAMBURG ✦ FRANKFURT ✦ KÖLN ✦ STUTTGART ✦ DÜSSELDORF ✦ BERLIN ✦ MÜNCHEN ✦ HAMBURG ✦ FRANKFURT ✦ KÖLN ✦ STUTTGART ✦ DÜSSELDORF</span>
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> BERLIN ✦ MÜNCHEN ✦ HAMBURG ✦ FRANKFURT ✦ KÖLN ✦ STUTTGART ✦ DÜSSELDORF ✦ BERLIN ✦ MÜNCHEN ✦ HAMBURG ✦ FRANKFURT ✦ KÖLN ✦ STUTTGART ✦ DÜSSELDORF</span>
        </div>
      </div>
    </>
