...
const COUNTRY = process.env.PUBLIC_COUNTRY_CODE || "DE";
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://esim-germany.com";
...
export default async function HomePage() {
  ...
  const subheadline = homepage?.heroSubheadline || "Prepaid-eSIM für Deutschland ohne Vertrag und ohne Roaming-Falle. QR-Code direkt per E-Mail — aktiv, bevor das Gepäckband startet.";
  ...
  const stepsList = (Array.isArray(rawSteps) && rawSteps.length > 0) ? rawSteps : [
    { step: "01", title: "Tarif für Deutschland wählen", description: "Wähle das passende Datenpaket für deine Reise. Der QR-Code wird sofort per E-Mail geliefert." },
