...
export const metadata: Metadata = {
  title: "Allgemeine Geschäftsbedingungen (AGB) | PoloSim Deutschland",
  description: "Allgemeine Geschäftsbedingungen für die Nutzung von PoloSim Deutschland eSIM Datendiensten.",
};
