    ...
    <>
      <div className="hero">
        <div>
          <div className="eyebrow">
            ...
            <span>EN VIVO · COBERTURA ESPAÑA</span>
          </div>

          <h1>
            Conéctate, <br />
            <span className="gradient-text">antes de aterrizar.</span>
          </h1>

          <p className="lead">{subheadline || "eSIM prepago para España sin contratos ni trampas de roaming. Código QR al instante por e-mail: activo antes de recoger la maleta."}</p>

          <div className="check">
            <label htmlFor="dev">¿Tu móvil es compatible con eSIM?</label>
            <div className="row">
        ...
        <div className="phone-stage">
          ...
          <div className="screen">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-mono text-xs text-[var(--c5)]">● Activo en Madrid</span>
            </div>
      ...
      <div className="ticker-wrap">
        <div className="ticker-move">
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> MADRID ✦ BARCELONA ✦ SEVILLA ✦ VALENCIA ✦ MÁLAGA ✦ BILBAO ✦ ALICANTE ✦ MADRID ✦ BARCELONA ✦ SEVILLA ✦ VALENCIA ✦ MÁLAGA ✦ BILBAO ✦ ALICANTE</span>
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> MADRID ✦ BARCELONA ✦ SEVILLA ✦ VALENCIA ✦ MÁLAGA ✦ BILBAO ✦ ALICANTE ✦ MADRID ✦ BARCELONA ✦ SEVILLA ✦ VALENCIA ✦ MÁLAGA ✦ BILBAO ✦ ALICANTE</span>
        </div>
      </div>
    </>
