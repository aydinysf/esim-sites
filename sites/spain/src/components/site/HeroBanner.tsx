...
export default function HeroBanner() {
  ...
  return (
    <>
      <div className="hero">
        <div>
          <h1>Llega, escanea y conéctate al instante.</h1>
          <p className="lead">eSIM prepago para España sin contratos ni cargos de roaming. El código QR llega al instante por e-mail.</p>
          <div className="check">
      ...
      <svg className="ridge" viewBox="0 0 1080 200" role="img" aria-label="Panorama">
        ...
        <g>
          <text x="128" y="172">Madrid</text>
          <text x="398" y="164">Barcelona</text>
          <text x="694" y="172">Sevilla</text>
          <text x="940" y="186">Valencia</text>
        </g>
      </svg>
    </>
  );
