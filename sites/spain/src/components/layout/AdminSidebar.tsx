...
const navItems = [
  ...
  { label: "─ Contenido", icon: "", href: "", divider: true },
  { href: "/admin/blog", label: "Blog", icon: "📝" },
  { href: "/admin/guides", label: "Guías", icon: "📚" },
  { href: "/admin/faq", label: "FAQ", icon: "❓" },
  { href: "/admin/pages", label: "Páginas", icon: "📄" },
  { label: "─ Diseño", icon: "", href: "", divider: true },
  { href: "/admin/banners", label: "Banners/Slider", icon: "🖼️" },
  { href: "/admin/media", label: "Galería de Medios", icon: "🎬" },
  { href: "/admin/menu", label: "Menú", icon: "☰" },
  { href: "/admin/homepage", label: "Inicio", icon: "🏠" },
];
  ...
  return (
    <aside className="w-60 bg-gray-900 text-gray-300 flex flex-col min-h-screen flex-shrink-0">
      <div className="p-5 border-b border-gray-700">
        <div className="font-bold text-white text-sm">🇪🇸 eSIM España</div>
        <div className="text-xs text-gray-500 mt-0.5">Panel de Control</div>
      </div>
