...
export const metadata: Metadata = {
  title: "Allgemeine Geschäftsbedingungen (AGB) | PoloSim España",
  description: "Allgemeine Geschäftsbedingungen für die Nutzung von PoloSim España eSIM Datendiensten.",
};
