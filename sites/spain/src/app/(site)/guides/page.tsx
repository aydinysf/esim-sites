...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: hp?.guidesPageTitle ? `${hp.guidesPageTitle} | ${hp.metaSiteTitle || "eSIM"}` : "Guides | España eSIM",
    description: hp?.guidesPageSubtitle || "Step-by-step guides for España eSIM.",
  };
}
