...
export const metadata: Metadata = {
  title: "Allgemeine Geschäftsbedingungen (AGB) | PoloSim Europa",
  description: "Allgemeine Geschäftsbedingungen für die Nutzung von PoloSim Europa eSIM Datendiensten.",
};
