...
export default async function HomePage() {
  ...
  const subheadline = homepage?.heroSubheadline || "Prepaid eSIM for 33 European countries with zero contracts and no roaming traps. Instant QR code via email — active before baggage claim.";
  ...
  const stepsList = (Array.isArray(rawSteps) && rawSteps.length > 0) ? rawSteps : [
    { step: "01", title: "Tarif für Europa wählen", description: "Wähle das passende Datenpaket für deine Reise. Der QR-Code wird sofort per E-Mail geliefert." },
