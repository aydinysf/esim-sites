...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: hp?.guidesPageTitle ? `${hp.guidesPageTitle} | ${hp.metaSiteTitle || "eSIM"}` : "Guides | Europe eSIM",
    description: hp?.guidesPageSubtitle || "Step-by-step guides for Europe eSIM.",
  };
}
