    ...
    <>
      <div className="hero">
        <div>
          <div className="eyebrow">
            ...
            <span>LIVE · COVERAGE EUROPE (33 COUNTRIES)</span>
          </div>
          ...
          <p className="lead">{subheadline || "Prepaid eSIM for 33 European countries with zero contracts and no roaming traps. Instant QR code via email — active before baggage claim."}</p>
        ...
        <div className="phone-stage">
          ...
          <div className="screen">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-mono text-xs text-[var(--c5)]">● Active in Europe</span>
            </div>
      ...
      <div className="ticker-wrap">
        <div className="ticker-move">
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> PARIS ✦ ROME ✦ BERLIN ✦ VIENNA ✦ AMSTERDAM ✦ MADRID ✦ PRAGUE ✦ PARIS ✦ ROME ✦ BERLIN ✦ VIENNA ✦ AMSTERDAM ✦ MADRID ✦ PRAGUE</span>
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> PARIS ✦ ROME ✦ BERLIN ✦ VIENNA ✦ AMSTERDAM ✦ MADRID ✦ PRAGUE ✦ PARIS ✦ ROME ✦ BERLIN ✦ VIENNA ✦ AMSTERDAM ✦ MADRID ✦ PRAGUE</span>
        </div>
      </div>
    </>
