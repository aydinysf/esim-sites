...
export default function HeroBanner() {
  ...
  return (
    <>
      <div className="hero">
        <div>
          <h1>Arrive, scan, and connect across Europe.</h1>
          <p className="lead">Prepaid eSIM for 33 European countries with zero contracts and no roaming fees. QR code delivered instantly.</p>
          <div className="check">
      ...
      <svg className="ridge" viewBox="0 0 1080 200" role="img" aria-label="Panorama">
        ...
        <g>
          <text x="128" y="172">Paris</text>
          <text x="398" y="164">Rome</text>
          <text x="694" y="172">Berlin</text>
          <text x="940" y="186">Vienna</text>
        </g>
      </svg>
    </>
  );
