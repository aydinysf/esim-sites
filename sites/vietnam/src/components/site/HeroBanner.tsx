...
export default function HeroBanner() {
  ...
  return (
    <>
      <div className="hero">
        <div>
          <h1>Đến nơi, quét mã, kết nối ngay.</h1>
          <p className="lead">eSIM trả trước cho Việt Nam không cần hợp đồng, không phí chuyển vùng. Mã QR gửi ngay qua e-mail.</p>
          <div className="check">
            <label htmlFor="dev">Điện thoại của bạn có hỗ trợ eSIM?</label>
            <div className="row">
      ...
      <svg className="ridge" viewBox="0 0 1080 200" role="img" aria-label="Panorama">
        ...
        <g>
          <text x="128" y="172">Hà Nội</text>
          <text x="398" y="164">Đà Nẵng</text>
          <text x="694" y="172">Hồ Chí Minh</text>
          <text x="940" y="186">Nha Trang</text>
        </g>
      </svg>
    </>
  );
