    ...
    <>
      <div className="hero">
        <div>
          <div className="eyebrow">
            ...
            <span>TRỰC TIẾP · PHỦ SÓNG VIỆT NAM</span>
          </div>

          <h1>
            Kết nối ngay, <br />
            <span className="gradient-text">trước khi hạ cánh.</span>
          </h1>

          <p className="lead">{subheadline || "eSIM trả trước cho Việt Nam không hợp đồng, không phí chuyển vùng. Mã QR gửi ngay qua email — kích hoạt trước khi lấy hành lý."}</p>

          <div className="check">
            <label htmlFor="dev">Điện thoại bạn có hỗ trợ eSIM?</label>
            <div className="row">
        ...
        <div className="phone-stage">
          ...
          <div className="screen">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-mono text-xs text-[var(--c5)]">● Kích hoạt tại Hà Nội</span>
            </div>
      ...
      <div className="ticker-wrap">
        <div className="ticker-move">
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> HÀ NỘI ✦ ĐÀ NẴNG ✦ HỒ CHÍ MINH ✦ NHA TRANG ✦ PHÚ QUỐC ✦ HUẾ ✦ CẦN THƠ ✦ HÀ NỘI ✦ ĐÀ NẴNG ✦ HỒ CHÍ MINH ✦ NHA TRANG ✦ PHÚ QUỐC ✦ HUẾ ✦ CẦN THƠ</span>
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> HÀ NỘI ✦ ĐÀ NẴNG ✦ HỒ CHÍ MINH ✦ NHA TRANG ✦ PHÚ QUỐC ✦ HUẾ ✦ CẦN THƠ ✦ HÀ NỘI ✦ ĐÀ NẴNG ✦ HỒ CHÍ MINH ✦ NHA TRANG ✦ PHÚ QUỐC ✦ HUẾ ✦ CẦN THƠ</span>
        </div>
      </div>
    </>
