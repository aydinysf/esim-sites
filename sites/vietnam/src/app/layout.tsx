...
export const metadata: Metadata = {
  ...
  title: {
    default: "eSIM Việt Nam | PoloSim",
    template: "%s | PoloSim",
  },
  description: "So sánh các gói dữ liệu eSIM tốt nhất cho Việt Nam và kích hoạt ngay lập tức.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  return (
    <html lang="vi" className={`${syne.variable} ${dmSans.variable}`}>
      <body className="antialiased">
        <OrganizationJsonLd siteUrl={siteUrl} siteName="eSIM Việt Nam | PoloSim" />
        {children}
      </body>
    </html>
  );
