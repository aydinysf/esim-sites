...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: hp?.faqPageTitle ? `${hp.faqPageTitle} | ${hp.metaSiteTitle || "eSIM"}` : "FAQ | Việt Nam eSIM",
    description: hp?.faqPageSubtitle || "Frequently asked questions about Việt Nam eSIM.",
  };
}
