...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: hp?.blogPageTitle ? `${hp.blogPageTitle} | ${hp.metaSiteTitle || "eSIM"}` : "Blog | Việt Nam eSIM",
    description: hp?.blogPageSubtitle || "Latest Việt Nam eSIM tips, guides and news.",
  };
}
