...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: hp?.guidesPageTitle ? `${hp.guidesPageTitle} | ${hp.metaSiteTitle || "eSIM"}` : "Guides | Việt Nam eSIM",
    description: hp?.guidesPageSubtitle || "Step-by-step guides for Việt Nam eSIM.",
  };
}
