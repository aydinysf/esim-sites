...
export const metadata: Metadata = {
  title: "Allgemeine Geschäftsbedingungen (AGB) | PoloSim Việt Nam",
  description: "Allgemeine Geschäftsbedingungen für die Nutzung von PoloSim Việt Nam eSIM Datendiensten.",
};
