...
export default async function HomePage() {
  ...
  const stepsList = (Array.isArray(rawSteps) && rawSteps.length > 0) ? rawSteps : [
    { step: "01", title: "Tarif für Vietnam wählen", description: "Wähle das passende Datenpaket für deine Reise. Der QR-Code wird sofort per E-Mail geliefert." },
  ...
  return (
    <>
      ...
      <HeroBanner
        ...
        activeCity="Hanoi"
        tickerCities="HANOI ✦ HO-CHI-MINH-STADT ✦ DA NANG ✦ NHA TRANG ✦ PHU QUOC ✦ HUE"
      />
