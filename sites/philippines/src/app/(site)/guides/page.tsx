...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: hp?.guidesPageTitle ? `${hp.guidesPageTitle} | ${hp.metaSiteTitle || "eSIM"}` : "Guides | Philippines eSIM",
    description: hp?.guidesPageSubtitle || "Step-by-step guides for Philippines eSIM.",
  };
}
