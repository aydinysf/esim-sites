...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: hp?.blogPageTitle ? `${hp.blogPageTitle} | ${hp.metaSiteTitle || "eSIM"}` : "Blog | Philippines eSIM",
    description: hp?.blogPageSubtitle || "Latest Philippines eSIM tips, guides and news.",
  };
}
