...
export default function HeroBanner() {
  ...
  return (
    <>
      <div className="hero">
        <div>
          <h1>Arrive, scan, and get online instantly.</h1>
          <p className="lead">Prepaid eSIM for the Philippines with zero contracts and no roaming fees. QR code delivered instantly to your inbox.</p>
          <div className="check">
