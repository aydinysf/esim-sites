...
export default function HeroBanner() {
  ...
  return (
    <>
      <div className="hero">
        <div>
          <h1>Sosește, scanează și fii online instant.</h1>
          <p className="lead">eSIM preplătit pentru România fără contracte și fără taxe de roaming. Codul QR soseste instant pe e-mail.</p>
          <div className="check">
            ...
            <div className="row">
              ...
              <a className="btn" href="#tarife">Vezi planurile</a>
            </div>
      ...
      <svg className="ridge" viewBox="0 0 1080 200" role="img" aria-label="Panorama">
        ...
        <g>
          <text x="128" y="172">București</text>
          <text x="398" y="164">Cluj</text>
          <text x="694" y="172">Timișoara</text>
          <text x="940" y="186">Brașov</text>
        </g>
      </svg>
    </>
  );
