    ...
    <>
      <div className="hero">
        <div>
          <div className="eyebrow">
            ...
            <span>LIVE · ACOPERIRE ROMÂNIA</span>
          </div>

          <h1>
            Conectează-te, <br />
            <span className="gradient-text">înainte de aterizare.</span>
          </h1>

          <p className="lead">{subheadline || "eSIM preplătit pentru România fără contracte și fără capcane de roaming. Cod QR instant pe e-mail — activ înainte de banda de bagaje."}</p>

          <div className="check">
            <label htmlFor="dev">Telefonul tău suportă eSIM?</label>
            <div className="row">
        ...
        <div className="phone-stage">
          ...
          <div className="screen">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-mono text-xs text-[var(--c5)]">● Activ în București</span>
            </div>
      ...
      <div className="ticker-wrap">
        <div className="ticker-move">
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> BUCUREȘTI ✦ CLUJ ✦ TIMIȘOARA ✦ BRAȘOV ✦ IAȘI ✦ CONSTANȚA ✦ SIBIU ✦ BUCUREȘTI ✦ CLUJ ✦ TIMIȘOARA ✦ BRAȘOV ✦ IAȘI ✦ CONSTANȚA ✦ SIBIU</span>
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> BUCUREȘTI ✦ CLUJ ✦ TIMIȘOARA ✦ BRAȘOV ✦ IAȘI ✦ CONSTANȚA ✦ SIBIU ✦ BUCUREȘTI ✦ CLUJ ✦ TIMIȘOARA ✦ BRAȘOV ✦ IAȘI ✦ CONSTANȚA ✦ SIBIU</span>
        </div>
      </div>
    </>
