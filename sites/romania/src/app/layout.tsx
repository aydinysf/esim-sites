...
export const metadata: Metadata = {
  ...
  title: {
    default: "eSIM România | PoloSim",
    template: "%s | PoloSim",
  },
  description: "Compară cele mai bune planuri de date eSIM pentru România și activează-le instant.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  return (
    <html lang="ro" className={`${syne.variable} ${dmSans.variable}`}>
      <body className="antialiased">
        <OrganizationJsonLd siteUrl={siteUrl} siteName="eSIM România | PoloSim" />
        {children}
      </body>
    </html>
  );
