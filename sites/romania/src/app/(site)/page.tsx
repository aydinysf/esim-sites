  ...
  return (
    <div className="w">
      ...
      <main>
        ...
        <section id="ablauf">
          <h2>Online în trei pași simpli</h2>
          <p className="sub">Configurarea durează mai puțin de 5 minute.</p>
          <div className="steps">
            <div>
              <h3>Alege planul</h3>
              <p>Selectează volumul de date dorit.</p>
            </div>
            <div>
              <h3>Plătește</h3>
              <p>Primești codul QR direct pe e-mail.</p>
            </div>
            <div>
              <h3>Scanează</h3>
              <p>Scanează codul QR și conectează-te.</p>
            </div>
          </div>
        </section>
