...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: hp?.blogPageTitle ? `${hp.blogPageTitle} | ${hp.metaSiteTitle || "eSIM"}` : "Blog | România eSIM",
    description: hp?.blogPageSubtitle || "Latest România eSIM tips, guides and news.",
  };
}
