...
export const nativeDict = {
  ...
  "nav_faq": "FAQ",
  "nav_blog": "Blog",
  "eyebrow_live": "DIREKT · NETZABDECKUNG SCHWEIZ",
  "headline_p1": "Verbinde dich",
  "headline_p2_1": "bevor ",
  "headline_p2_2": "du ",
  "headline_p3": "landest.",
  "subheadline_fallback": "Prepaid-eSIM für die Schweiz ohne Vertrag und ohne Roaming-Falle. QR-Code direkt per E-Mail — aktiv, bevor das Gepäckband startet.",
  ...
  "stage_active_in": "Aktiv in Zürich",
  ...
  "step1_title": "Tarif für die Schweiz wählen",
