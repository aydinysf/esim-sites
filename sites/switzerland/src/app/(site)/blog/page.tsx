...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: hp?.blogPageTitle ? `${hp.blogPageTitle} | ${hp.metaSiteTitle || "eSIM"}` : "Blog | Schweiz eSIM",
    description: hp?.blogPageSubtitle || "Latest Schweiz eSIM tips, guides and news.",
  };
}
