...
export const metadata: Metadata = {
  title: "Allgemeine Geschäftsbedingungen (AGB) | PoloSim Schweiz",
  description: "Allgemeine Geschäftsbedingungen für die Nutzung von PoloSim Schweiz eSIM Datendiensten.",
};
