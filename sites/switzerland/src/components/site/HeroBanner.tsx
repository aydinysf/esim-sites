    ...
    <>
      <div className="hero">
        <div>
          <div className="eyebrow">
            ...
            <span>LIVE · NETZABDECKUNG SCHWEIZ</span>
          </div>
          ...
          <p className="lead">{subheadline || "Prepaid-eSIM für die Schweiz ohne Vertrag und ohne Roaming-Falle. QR-Code direkt per E-Mail — aktiv, bevor das Gepäckband startet."}</p>
        ...
        <div className="phone-stage">
          ...
          <div className="screen">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-mono text-xs text-[var(--c5)]">● Aktiv in Zürich</span>
            </div>
      ...
      <div className="ticker-wrap">
        <div className="ticker-move">
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> ZÜRICH ✦ GENF ✦ BASEL ✦ BERN ✦ LUZERN ✦ LAUSANNE ✦ ST. GALLEN ✦ ZÜRICH ✦ GENF ✦ BASEL ✦ BERN ✦ LUZERN ✦ LAUSANNE ✦ ST. GALLEN</span>
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> ZÜRICH ✦ GENF ✦ BASEL ✦ BERN ✦ LUZERN ✦ LAUSANNE ✦ ST. GALLEN ✦ ZÜRICH ✦ GENF ✦ BASEL ✦ BERN ✦ LUZERN ✦ LAUSANNE ✦ ST. GALLEN</span>
        </div>
      </div>
    </>
