...
export const metadata: Metadata = {
  title: "Allgemeine Geschäftsbedingungen (AGB) | PoloSim Österreich",
  description: "Allgemeine Geschäftsbedingungen für die Nutzung von PoloSim Österreich eSIM Datendiensten.",
};
