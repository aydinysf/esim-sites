...
export const metadata: Metadata = {
  ...
  title: {
    default: "eSIM Österreich | PoloSim",
    template: "%s | PoloSim",
  },
  description: "Die besten eSIM-Tarife für Österreich vergleichen und sofort aktivieren.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  return (
    <html lang="de" className={`${syne.variable} ${dmSans.variable}`}>
      <body className="antialiased">
        <OrganizationJsonLd siteUrl={siteUrl} siteName="eSIM Österreich | PoloSim" />
        {children}
      </body>
    </html>
  );
