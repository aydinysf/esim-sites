    ...
    <>
      <div className="hero">
        <div>
          ...
          <p className="lead">Prepaid-eSIM für Österreich ohne Vertrag und ohne Roaming-Gebühren. Der QR-Code kommt sofort per E-Mail.</p>
          <div className="check">
      ...
      <svg className="ridge" viewBox="0 0 1080 200" role="img" aria-label="Panorama">
        ...
        <g>
          <text x="128" y="172">Innsbruck</text>
          <text x="398" y="164">Salzburg</text>
          <text x="694" y="172">Wien</text>
          <text x="940" y="186">Graz</text>
        </g>
      </svg>
    </>
  );
