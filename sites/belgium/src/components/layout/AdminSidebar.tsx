...
const navItems = [
  ...
  { label: "─ Inhoud", icon: "", href: "", divider: true },
  { href: "/admin/blog", label: "Blog", icon: "📝" },
  { href: "/admin/guides", label: "Gidsen", icon: "📚" },
  { href: "/admin/faq", label: "FAQ", icon: "❓" },
  { href: "/admin/pages", label: "Pagina’s", icon: "📄" },
  { label: "─ Ontwerp", icon: "", href: "", divider: true },
  { href: "/admin/banners", label: "Banners/Slider", icon: "🖼️" },
  { href: "/admin/media", label: "Mediagalerij", icon: "🎬" },
  { href: "/admin/menu", label: "Menu", icon: "☰" },
  { href: "/admin/homepage", label: "Home", icon: "🏠" },
];
  ...
  return (
    <aside className="w-60 bg-gray-900 text-gray-300 flex flex-col min-h-screen flex-shrink-0">
      <div className="p-5 border-b border-gray-700">
        <div className="font-bold text-white text-sm">🇧🇪 eSIM België</div>
