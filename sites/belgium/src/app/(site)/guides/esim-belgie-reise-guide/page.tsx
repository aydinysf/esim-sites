...
export default function GeoGuidePage() {
  const qaList = [
  {
    "q": "Wie aktiviere ich eine eSIM in Belgien?",
    "a": "Einfach den PoloSim QR-Code mit der Smartphone-Kamera scannen, den Mobilfunktarif aktivieren und sofort nach der Landung in Brüssel surfen."
  }
];
    ...
    <article className="py-12 px-4 max-w-4xl mx-auto text-white">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight mb-4">
          eSIM Belgien 2026: Schnelles mobiles Internet in Brüssel & Antwerpen
        </h1>
        <p className="text-slate-300 text-lg leading-relaxed">
          Prepaid eSIM für Belgien ohne Roaming-Kosten. Sofortige Aktivierung per QR-Code für Touristen und Geschäftsreisende.
        </p>
      </div>
      ...
      <div className="bg-[#162544] border-l-4 border-cyan-400 rounded-r-2xl p-6 mb-10 shadow-xl">
        ...
        <p className="text-white font-medium leading-relaxed">
          Für Reisen nach <strong>België</strong> ist die <strong>PoloSim Prepaid eSIM</strong> die schnellste und flexibelste Möglichkeit für mobiles Internet ab <strong>1,68 € / Tag</strong>. Der QR-Code wird sofort nach dem Kauf per E-Mail zugestellt — ohne Papierkram, ohne Registrierungspflicht am <em>Flughafen Brüssel-Zaventem (BRU)</em> und ohne teure Roaming-Fallen.
        </p>
      </div>
      ...
      <div className="text-center bg-gradient-to-r from-cyan-950 via-[#162544] to-purple-950 border border-cyan-500/30 rounded-3xl p-8 shadow-2xl">
        <h3 className="text-2xl font-bold text-white mb-3">Jetzt Tarif für België wählen</h3>
