  ...
  return (
    <div className="w">
      ...
      <main>
        ...
        <section id="ablauf">
          <h2>In drie stappen online</h2>
          <p className="sub">Instellen duurt minder dan vijf minuten.</p>
          <div className="steps">
            <div>
              <h3>Kies bundel</h3>
              <p>Selecteer databundel en geldigheid.</p>
            </div>
            <div>
              <h3>Betalen</h3>
              <p>Ontvang de QR-code direct in je mailbox.</p>
            </div>
            <div>
              <h3>Scannen</h3>
              <p>Scan de QR-code, activeer en surf direct.</p>
            </div>
          </div>
        </section>
