...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: hp?.faqPageTitle ? `${hp.faqPageTitle} | ${hp.metaSiteTitle || "eSIM"}` : "FAQ | België eSIM",
    description: hp?.faqPageSubtitle || "Frequently asked questions about België eSIM.",
  };
}
