...
export const metadata: Metadata = {
  ...
  title: {
    default: "eSIM België | PoloSim",
    template: "%s | PoloSim",
  },
  description: "Vergelijk de beste eSIM-databundels voor België en activeer ze direct.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  return (
    <html lang="nl" className={`${syne.variable} ${dmSans.variable}`}>
      <body className="antialiased">
        <OrganizationJsonLd siteUrl={siteUrl} siteName="eSIM België | PoloSim" />
        {children}
      </body>
    </html>
  );
