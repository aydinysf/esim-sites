...
export default function HeroBanner() {
  ...
  return (
    <>
      <div className="hero">
        <div>
          <h1>Přijeďte, naskenujte a buďte ihned online.</h1>
          <p className="lead">Předplacená eSIM pro Česko bez smluv a roamingových poplatků. QR kód obdržíte ihned e-mailem.</p>
          <div className="check">
      ...
      <svg className="ridge" viewBox="0 0 1080 200" role="img" aria-label="Panorama">
        ...
        <g>
          <text x="128" y="172">Praha</text>
          <text x="398" y="164">Brno</text>
          <text x="694" y="172">Ostrava</text>
          <text x="940" y="186">Plzeň</text>
        </g>
      </svg>
    </>
  );
