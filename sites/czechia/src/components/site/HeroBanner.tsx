    ...
    <>
      <div className="hero">
        <div>
          <div className="eyebrow">
            ...
            <span>ŽIVĚ · POKRYTÍ ČESKO</span>
          </div>

          <h1>
            Připojte se, <br />
            <span className="gradient-text">než přistanete.</span>
          </h1>

          <p className="lead">{subheadline || "Předplacená eSIM pro Česko bez smluv a roamingových pastí. QR kód ihned e-mailem — aktivní ještě před vyzvednutím zavazadel."}</p>

          <div className="check">
            <label htmlFor="dev">Podporuje váš telefon eSIM?</label>
            <div className="row">
        ...
        <div className="phone-stage">
          ...
          <div className="screen">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-mono text-xs text-[var(--c5)]">● Aktivní v Praze</span>
            </div>
      ...
      <div className="ticker-wrap">
        <div className="ticker-move">
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> PRAHA ✦ BRNO ✦ OSTRAVA ✦ PLZEŇ ✦ LIBEREC ✦ OLOMOUC ✦ PARDUBICE ✦ PRAHA ✦ BRNO ✦ OSTRAVA ✦ PLZEŇ ✦ LIBEREC ✦ OLOMOUC ✦ PARDUBICE</span>
          <span><span style={{ color: "var(--c4)" }}>SIGNAL::</span> PRAHA ✦ BRNO ✦ OSTRAVA ✦ PLZEŇ ✦ LIBEREC ✦ OLOMOUC ✦ PARDUBICE ✦ PRAHA ✦ BRNO ✦ OSTRAVA ✦ PLZEŇ ✦ LIBEREC ✦ OLOMOUC ✦ PARDUBICE</span>
        </div>
      </div>
    </>
