...
export const metadata: Metadata = {
  title: "Allgemeine Geschäftsbedingungen (AGB) | PoloSim Česko",
  description: "Allgemeine Geschäftsbedingungen für die Nutzung von PoloSim Česko eSIM Datendiensten.",
};
